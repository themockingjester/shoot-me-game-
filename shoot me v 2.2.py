...
class mapp(tk.Tk):
    ...
    def start(self):
        ...
        self.playb=tk.Button(self,bg="blue",text='PLAY',command=self.play,font=("garamond", "15","bold")) 
        self.playb.place(x=450,y=30)
        self.pauseb=tk.Button(self,bg="blue",text='PAUSE',command=self.pause,font=("garamond", "15","bold"))
